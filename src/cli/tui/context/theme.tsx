...
import ffmpegProcessorTheme from './theme/ffmpeg-processor.json' with { type: 'json' };
...
export const { use: useTheme, provider: ThemeProvider } = createSimpleContext({
  ...
  init: (props: { mode: 'dark' | 'light' }) => {
    const theme = createMemo(() => resolveTheme(ffmpegProcessorTheme as ThemeJson, props.mode));
